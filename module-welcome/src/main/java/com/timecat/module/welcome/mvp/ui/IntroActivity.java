 ...
 * 欢迎页面，启动页
 */
@RouterAnno(hostAndPath = RouterHub.WELCOME_IntroActivity)
public class IntroActivity extends BaseThemeActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        titles = new String[]{
                ...
                getString(R.string.welcome_Page2Title),
                getString(R.string.welcome_Page3Title),
                getString(R.string.welcome_Page5Title),
                getString(R.string.welcome_Page4Title),
                getString(R.string.welcome_Page6Title)
        };
        messages = new String[]{
                getString(R.string.welcome_Page1Message),
                getString(R.string.welcome_Page2Message),
                getString(R.string.welcome_Page3Message),
                getString(R.string.welcome_Page5Message),
                getString(R.string.welcome_Page4Message),
                getString(R.string.welcome_Page6Message)
        };
        ...
        startMessagingButton.setText(R.string.welcome_entry);
        ...
        startMessagingButton.setOnClickListener(view -> {
            ...
            NAV.goAndFinish(IntroActivity.this, RouterHub.WELCOME_WelcomeGuideActivity);
        });
        ...
        if (Space.isTablet()) {
            ...
            BitmapDrawable drawable = (BitmapDrawable) ResourcesCompat.getDrawable(getResources(), R.drawable.catstile, null);
    ...
    public class EGLThread extends DispatchQueue {
        ...
        private boolean initGL() {
            ...
            loadTexture(R.drawable.ic_pin, 9);
            ...
            loadTexture(R.drawable.ic_star, 18);
            loadTexture(R.drawable.intro_private_door, 19);
            loadTexture(R.drawable.intro_private_screw, 20);
            loadTexture(R.mipmap.ic_launcher, 21);
        ...
        private void loadTexture(int resId, int index) {
            ...
            if (drawable instanceof BitmapDrawable) {
                ...
                loadBitmap(bitmap, index);
            }
        }

        private void loadBitmap(Bitmap bitmap, int index) {
